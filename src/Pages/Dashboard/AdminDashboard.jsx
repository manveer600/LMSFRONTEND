...
function AdminDashboard() {
  ...
  console.log("monthlysales", monthlySalesRecord);
  ...
  return (
    <HomeLayout>
      <div className="min-h-[90vh] w-full font-serif pt-5 flex flex-col flex-wrap gap-10 text-white">
        <h1 className="text-center underline mt-20 text-3xl sm:text-5xl font-semibold text-yellow-500">
          Admin Dashboard
        </h1>
        ...
        <div className="gap-10 overflow-x-scroll w-full mb-10">
          ...
          {courses.length ? (
            ...
            <div className="text-center font-bold font-serif text-yellow-400 text-3xl mt-3">
              No courses found
            </div>
          )}
        </div>
